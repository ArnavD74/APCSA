...
{  
   ...
   {  
      ...
      g2.drawString("Distance: " + Integer.toString((int) d1), (int) point1.x, (int) point1.y);
      g2.drawString("Distance: " + Integer.toString((int) d2), (int) point2.x, (int) point2.y);
      g2.drawString("Distance: " + Integer.toString((int) d3), (int) point3.x, (int) point3.y);
